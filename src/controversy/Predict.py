...
import numpy as np
from src.controversy.Model import convert_sentences_to_ff, convert_sentences_to_rnn, predict_probability_controversial, max_sequence_length, load_word2vec_index_maps, word2vec_index_file
import pandas as pd
...
if __name__ == '__main__':
    ...
    for sample in samples:
        controversiality_prob = predict_probability_controversial(sample[0], sample[1], model,
